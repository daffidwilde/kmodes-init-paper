...
\author[cardiffmaths]{Henry Wilde\corref{corrauthor}}
\cortext[corrauthor]{Corresponding author}
\ead{wildehd@cardiff.ac.uk}

\author[cardiffmaths]{Vincent Knight}

\author[cardiffmaths]{Jonathan Gillard}

\address[cardiffmaths]{%
