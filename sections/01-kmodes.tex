...
\begin{example}
    ...
    Let us consider three of our points: aardvark, antelope and bass. With our 
    notation, these points can be expressed as the following vectors:
    ...
    And their pairwise dissimilarities are:
    \begin{equation}
    \nonumber
    \begin{aligned}
