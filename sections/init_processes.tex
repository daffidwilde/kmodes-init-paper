...
\begin{example}\label{ex:cao}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}{\textwidth}
            ...
            \end{pmatrix}
            \)
            \captionof{figure}{Our density-dissimilarity matrix
            \(\mathbb{D}\).}\label{fig:cao-matrix-1}
        \end{minipage}
        ...
        \begin{minipage}{\textwidth}
            ...
            \end{pmatrix}
            \)
            \captionof{figure}{Highlighting which mode has smaller
                density-dissimilarity product for each
                datapoint.}\label{fig:cao-matrix-2}
        \end{minipage}
        ...
        \begin{minipage}{\textwidth}
            ...
            \end{pmatrix}
            \)
            \captionof{figure}{Selecting point with maximal
                density-dissimilarity product of those
                highlighted.}\label{fig:cao-matrix-3}
        \end{minipage}
        }
    \end{figure}
