""" Source code to produce datasets where Huang's method outperforms the
matching initialisation in terms of initial cost. """
...
PATH = Path("../../../data/huang_over_matching_initial_cost/")
